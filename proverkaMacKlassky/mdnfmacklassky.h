...
private:
    ...
    bool calculate(int type, QStringList &listFunc, QStringList &skleyka1, QStringList &skleyka2, QStringList &skleyka3, QStringList &minList, int &varsCount, int &skleykiCount, int &mintermsCount, QString &coreFormula); // type = 1 - МДНФ, type = 0 - МКНФ, minList - список, куда вернётся функция
